...
public class ImmunityEffect extends AlchemyEffect {
    ...
    @Override
    public void apply() {
        player.sendMessage("§a[" + effectName + "] Effect started: You are immune to mob damage for " + (durationMillis / 1000) + " seconds.");
    ...
    public void remove() {
        ...
        player.sendMessage("§c[" + effectName + "] Effect ended: Immunity expired.");
    }
}
