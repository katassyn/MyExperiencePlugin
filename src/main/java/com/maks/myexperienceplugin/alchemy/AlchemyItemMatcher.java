...
public class AlchemyItemMatcher {
    ...
    public static String matchItem(ItemStack item) {
        if (item == null || !item.hasItemMeta()) {
            //System.out.println("Item null or no meta");
            return null;
        }

        ItemMeta meta = item.getItemMeta();
        if (meta == null || !meta.hasDisplayName()) {
            //System.out.println("Meta null or no display name");
            return null;
        }
        ...
        // For Phycis items that match the pattern in your logs
        ...
        // If nothing matched, log that for debugging
        //System.out.println("No matching key found for: " + display);
        return null;
    }
}
