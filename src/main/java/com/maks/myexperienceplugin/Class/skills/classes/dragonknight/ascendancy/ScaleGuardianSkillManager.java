...
public class ScaleGuardianSkillManager extends BaseSkillManager {
    ...
    protected void setupTreeStructure(SkillTree tree) {
        ...
        tree.connectNodes(ID_OFFSET + 9, ID_OFFSET + 18);
        tree.connectNodes(ID_OFFSET + 13, ID_OFFSET + 17);
        tree.connectNodes(ID_OFFSET + 18, ID_OFFSET + 24);
        tree.connectNodes(ID_OFFSET + 17, ID_OFFSET + 24);
        tree.connectNodes(ID_OFFSET + 24, ID_OFFSET + 25);

        // Path 2: Damage Reflection Path
        ...
        tree.connectNodes(ID_OFFSET + 11, ID_OFFSET + 15);
        tree.connectNodes(ID_OFFSET + 12, ID_OFFSET + 20);
        tree.connectNodes(ID_OFFSET + 15, ID_OFFSET + 21);
        tree.connectNodes(ID_OFFSET + 20, ID_OFFSET + 23);
        tree.connectNodes(ID_OFFSET + 21, ID_OFFSET + 23);
        tree.connectNodes(ID_OFFSET + 23, ID_OFFSET + 26);

        // Path 3: Proximity Defense Path
        tree.connectNodes(ID_OFFSET + 3, ID_OFFSET + 6);
        tree.connectNodes(ID_OFFSET + 3, ID_OFFSET + 7);
        tree.connectNodes(ID_OFFSET + 6, ID_OFFSET + 10);
        tree.connectNodes(ID_OFFSET + 7, ID_OFFSET + 14);
        ...
        tree.connectNodes(ID_OFFSET + 19, ID_OFFSET + 22);
